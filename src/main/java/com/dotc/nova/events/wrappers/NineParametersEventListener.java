...
public abstract class NineParametersEventListener<ParamOneType, ParamTwoType, ParamThreeType, ParamFourType, ParamFiveType, ParamSixType, ParamSevenType, ParamEightType, ParamNineType> implements
		EventListener {

	abstract void handle(ParamOneType param1, ParamTwoType param2, ParamThreeType param3, ParamFourType param4, ParamFiveType param5, ParamSixType param6, ParamSevenType param7,
	...
	public void handle(Object... data) {
		...
		handle(param1, param2, param3, param4, param5, param6, param7, param8, param9);
	}
}
