...
import com.dotc.nova.events.wrappers.EightParametersEventListener;
import com.dotc.nova.events.wrappers.FiveParametersEventListener;
import com.dotc.nova.events.wrappers.FourParametersEventListener;
...
import com.dotc.nova.events.wrappers.SevenParametersEventListener;
import com.dotc.nova.events.wrappers.SingleParameterEventListener;
import com.dotc.nova.events.wrappers.SixParametersEventListener;
import com.dotc.nova.events.wrappers.TenParametersEventListener;
import com.dotc.nova.events.wrappers.ThreeParametersEventListener;
import com.dotc.nova.events.wrappers.TwoParametersEventListener;
...
public class EventListenerWrappersTest {
	...
	public void testInvokingWithoutParams() {
		...
		TenParametersEventListener<String, Integer, Double, Long, Float, Byte, Boolean, Character, String, Double> listener10 = (param1,
		...
		NineParametersEventListener<String, Integer, Double, Long, Float, Byte, Boolean, Character, String> listener9 = (param1, param2,
		...
		EightParametersEventListener<String, Integer, Double, Long, Float, Byte, Boolean, Character> listener8 = (param1, param2, param3,
		...
		SevenParametersEventListener<String, Integer, Double, Long, Float, Byte, Boolean> listener7 = (param1, param2, param3, param4,
		...
		SixParametersEventListener<String, Integer, Double, Long, Float, Byte> listener6 = (param1, param2, param3, param4, param5, param6) -> {
		...
		FiveParametersEventListener<String, Integer, Double, Long, Float> listener5 = (param1, param2, param3, param4, param5) -> {
