...
* [nova-comm](./comm/README.md): communication base library, protocol agnostic reactive message sending and retrieval
* [nova-jms](./jms/README.md): reactive JMS messaging
* [nova-http](./http/README.md): reactive HTTP communication
* [nova-event-annotations](./event-annotations/README.md): allows your spring beans to automatically connect to the EventBus using annotations
* [nova-service](./service/README.md): Small service skeleton with a defined lifecycle and easy access to Nova and its EventBus 
* ...
