...
public class RestAdapter<MessageType> {
    private final RestClient<MessageType> rpcClient;
    ...
    public static class Builder<MessageType> {
        ...
        private RestClient<MessageType> rpcClient;
        ...
        public RestAdapter<MessageType> build() {
            validate();
            rpcClient = new RestClient<>(identifier, messageMarshaller, messageUnmarshaller, metrics);
