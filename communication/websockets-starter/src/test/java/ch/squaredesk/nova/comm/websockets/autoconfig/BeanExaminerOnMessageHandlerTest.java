...
public class BeanExaminerOnMessageHandlerTest {
    ...
    void beanExaminerCreatesEndpointForCustomMarshaller() throws Exception {
        class SomeClass {
            @OnMessage(value = "x", messageMarshallerClassName = "ch.squaredesk.nova.comm.websockets.autoconfig.BeanExaminerOnMessageHandlerTest$StringMarshaller")
    ...
    void beanExaminerCreatesEndpointForCustomUnmarshaller() throws Exception {
        class SomeClass {
            @OnMessage(value = "x", messageUnmarshallerClassName = "ch.squaredesk.nova.comm.websockets.autoconfig.BeanExaminerOnMessageHandlerTest$StringUnmarshaller")
            void handle(String message, WebSocket webSocket) {
            }
        }
        Collection<OnMessageHandlerEndpointDescriptor> endpoints = sut.onMessageEndpointsIn(new SomeClass());
    ...
    void beanExaminerThrowsForInvalidCustomMarshaller() throws Exception {
        ...
        assertThat(ex.getMessage(), is("Class ch.squaredesk.nova.comm.websockets.autoconfig.BeanExaminerOnMessageHandlerTest$StringMarshaller is not a valid MessageMarshaller for method handle"));
    }
    ...
    void beanExaminerThrowsForInvalidCustomUnmarshaller() throws Exception {
        ...
        assertThat(ex.getMessage(), is("Class ch.squaredesk.nova.comm.websockets.autoconfig.BeanExaminerOnMessageHandlerTest$StringUnmarshaller is not a valid MessageUnmarshaller for method handle"));
    }
